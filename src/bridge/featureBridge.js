...
module.exports = {
  ...
  initialize() {
    ...
    ipcMain.handle('settings:get-active-preset', async () => await settingsService.getActivePreset());
    ipcMain.handle('settings:set-active-preset', async (event, presetId) => await settingsService.setActivePreset(presetId));
